...
Any public use of Hazeru or Derivative Universes must include the notice:
“Created using the Hazeru universe‑level language.”

4.4 No Misrepresentation
You may not claim ownership of Hazeru, its cosmology, or its core laws.

5. Commercial Use
Commercial use is not permitted under HPL‑1.0 without a separate commercial license.
This includes:

enterprise deployments
paid software
monetized simulations
commercial universe engines
integration into proprietary systems
A commercial license may be requested from the Hazeru rights holder.

6. Derivative Universes
Derivative Universes created using Hazeru:

belong to their creators
must acknowledge Hazeru
must not claim to be official Hazeru cosmologies
must not redefine Hazeru’s core laws
7. Integrity of the Cosmology
Hazeru’s core laws, morphogenetic rules, recursion model, and continuity layer are protected elements.
No licensee may:

alter them
rebrand them
create competing “Hazeru‑like” cosmologies
distribute modified versions
8. Warranty Disclaimer
Hazeru is provided “as is,” without warranty of any kind.
The authors are not liable for any damages arising from its use.

9. Termination
Violation of any clause in this license results in immediate termination of rights.
Upon termination, all use of Hazeru must cease.

10. License Versioning
Future versions of HPL may be released.
Licensees may choose to adopt newer versions but are not required to.
